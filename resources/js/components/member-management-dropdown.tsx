...
export function MemberManagementDropdown({
    ...
    const handlePositionChange = (position: string | null) => {
        router.put(
            teams.members.updatePosition({ teamId, userId: member.user_id })
                .url,
            { position },
            {
                preserveScroll: true,
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ¿Estás seguro de que quieres transferir la capitanía
                            a{' '}
                            <span className="font-semibold">
                                {member.user.name}
                            </span>
                            ? Te convertirás en un jugador regular después de
                            esta acción.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
