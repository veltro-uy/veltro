...
export default function Lineup({
	...
	const handleTogglePlayer = (userId: number) => {
		setSelectedPlayers((prev) => {
			...
			return [...prev, { user_id: userId, position: null, is_starter: true }];
		});
	};
	...
	return (
		<AppLayout breadcrumbs={breadcrumbs}>
			...
			<div className="flex h-full flex-1 flex-col gap-6 p-6">
				<div>
					<h1 className="text-3xl font-bold tracking-tight">Select Lineup</h1>
					<p className="text-muted-foreground">
						Choose at least {minimumPlayers} players for your starting lineup
					</p>
				</div>
				...
				<Card className="max-w-3xl">
					<CardHeader>
						...
						<CardDescription>
							Selected {selectedPlayers.length} / {minimumPlayers} minimum players
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
							...
							return (
								...
								>
									<Checkbox
										...
										checked={isSelected}
										onCheckedChange={() => handleTogglePlayer(member.user_id)}
									/>
									...
									{isSelected && (
										<div className="w-40">
											<Select
												value={getPlayerPosition(member.user_id)}
												onValueChange={(value) =>
													handlePositionChange(member.user_id, value)
												}
											>
												<SelectTrigger>
						...
						<div className="flex gap-3 pt-4">
							<Button
								...
								disabled={selectedPlayers.length < minimumPlayers}
							>
